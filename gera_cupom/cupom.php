...
$consulta_sqlite = $db->query("SELECT t.total as total_nota,t.ID_FORMAPGTO,t.VALOR_RECEBIDO,t.TROCO,t.ENTREGAR,t.frete, ped.* from TMPPEDIDOS t join TMPITENS_PEDIDO ped on t.ID_PEDIDO = ped.ID_PEDIDO where ped.ID_PEDIDO = {$n}");
    ...
    <div class="cupom">
        ...
        <p id="linha">--------------------------------------------------------------</p>  
            ...
            <div class="finaliza">
                ...
                <h4 class="valor_final">FRETE: R$ <?php echo number_format($produtos['FRETE'],2,',',' '); ?></h4>
                <h4 class="valor_final">TOTAL + FRETE: R$ <?php echo number_format($produtos['FRETE'] + $total,2,',',' '); ?></h4>
