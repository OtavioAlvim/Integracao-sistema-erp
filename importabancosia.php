...
$diretorio = __DIR__;
$diretorioBancoCompactado = $diretorio  .DIRECTORY_SEPARATOR. "DB". DIRECTORY_SEPARATOR . $_SESSION['cnpj'] . DIRECTORY_SEPARATOR ."FTP\DB-IMPORTACAO". DIRECTORY_SEPARATOR .$nomeArquivoCompactado;
