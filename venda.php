...
/////////////////////////////////////////////////////////////////////////////////////////////////
$consulta_sqlite = $pdo->query("SELECT coalesce(i.DESCRICAO, 0) as resultado, p.ID_PEDIDO,p.FRETE  from TMPPEDIDOS p left join TMPITENS_PEDIDO i on p.ID_PEDIDO = i.ID_PEDIDO where p.VENDEDOR = '{$_SESSION['usuario']}' order by p.ID_PEDIDO DESC limit 1");
...
$_SESSION['totalComFrete'] = $frete + $tot_vendas;
/////////////////////////////////////////////////////////////////////////////////////////////////
$sql = $pdo->query("SELECT T.ID,T.UNITARIO,T.total,T.QTD, substr(T.DESCRICAO,1, 27) AS DESCRICAO FROM TMPITENS_PEDIDO T WHERE T.ID_PEDIDO = {$id_ultimo_pedido} order by T.ID desc");
...
if (isset($_SESSION['reinicia'])) :
    header("Refresh: 0");
endif;
unset($_SESSION['reinicia']);
    ?>
    <!DOCTYPE html>
    <html lang="pt-br">
        ...
        <div class="lateral_direita">
            <div class="informa">
                ...
                <div id="logo">
                    ...
                    <img src="imgens/novo bia.png" alt="">
                </div>
            </div>
        </div>
                    ...
                    <div id="forma_pagamento_finalizar">
                        <form class="finaliza" action="processamento/finaliza.php" method="GET">
                            ...
                            <div class="testado">
                                ...
                                <input type="number" step="0.01" name="frete" value="<?php echo $frete; ?>" disabled>
                            </div>
                            <div class="testado">
                                <h1>TOTAL + FRETE</h1>
                                <input type="number" step="0.01" value="<?php echo $frete + $tot_vendas; ?>" disabled>
                            </div>
                            <div id="testado" class="testado">
                                <h1>VALOR RECEBIDO</h1>
                                <input name="valor_recebido" type="number" step="0.01" id="troco" required>
                            </div>
                            <div class="testado">
                                <h1>VALOR TROCO</h1>
                            ...
                            <select id="estados" name="forma" required>
                            ...
                            <div class="finalizar_venda">
                                <input id="submit" type="submit" value="finalizar" accesskey="s" required>
                            </div>
                ...
                <div class="modal" id="modal_endereco">
                    <div class="modal-content">
                        ...
                        <div class="container_entrega">
                            <h3 id="titulo_exclui_item">Insira os dados para entrega</h3>
                            <hr>
                            <form action="./processamento/insere_frete.php" method="post">
                                <div class="dados_para_entrega">
                                    ...
                                    <input type="number" id="fretes" name="id_pedido" value="<?php echo $id_ultimo_pedido; ?>" required><br>
                                </div>
                                <div class="dados_para_entrega">
                        ...
                        <div class="container theme-showcase" role="main">
                            ...
                            <div class="row">
                                <table class="testandoGrid">
                                    <tr>
                                        <th class="titulo_cod_modal_prod">
                                            <h2>COD</h2>
                                        </th>
                                        <th class="titulo_desc_modal_prod">
                                            <h2>DESCRIÇÃO</h2>
                                        </th>
                                        <th class="titulo_un_modal_prod">
                                            <h2>UN</h2>
                                        </th>
                                        <th class="titulo_unitario_modal_prod">
                                            <h2>VALOR</h2>
                                        </th>
                                    </tr>
                                </table>
