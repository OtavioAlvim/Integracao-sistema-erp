              ...
              <ul class="navbar-nav">
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-dark">
                    ...
                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Resumo diario</a></li>
                  </ul>
                </li>
              </ul>
              <ul class="navbar-nav">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Resumo Diario</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="./gera_cupom/resumo_diario.php" method="POST">
          <h1>Resumo Diario</h1>
          <label for="">Inicio</label>
          <input type="date" name="inicio" class="form-control" id="validationCustom03" required><br>
          <label for="">Fim</label>
          <input type="date" name="fim" class="form-control" id="validationCustom03" required>
